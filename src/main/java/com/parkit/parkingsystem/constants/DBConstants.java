...
/**
 * Generates the various database constants facilitating the access
 */
public class DBConstants {
    ...
    public static final String NUMBER_OF_VISITS = "SELECT COUNT(*) from ticket WHERE VEHICLE_REG_NUMBER=?"; //for frequent users
